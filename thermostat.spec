...
%changelog
* Thu Apr 28 2016 Severin Gehwolf <sgehwolf@redhat.com> - 1.4.4-70.3
- Require mongo-java-driver > 2.14 so as to avoid bundle
  wiring issues.
- Resolves: RHBZ#1328519

* Wed Apr 27 2016 Severin Gehwolf <sgehwolf@redhat.com> - 1.4.4-70.2
- Use /dev/urandom for tomcat@thermostat service.
- Resolves: RHBZ#1328972

* Wed Mar 30 2016 Severin Gehwolf <sgehwolf@redhat.com> - 1.4.4-70.1
- Update to latest upstream 1.4.4 release.
- Resolves: RHBZ#1316863

* Wed Mar 30 2016 Severin Gehwolf <sgehwolf@redhat.com> - 1.4.2-70.3
- Own in-collection directories.
- Resolves: RHBZ#1317970

* Fri Jan 29 2016 Severin Gehwolf <sgehwolf@redhat.com> - 1.4.2-70.2
- Directly point to RHSCL 2.2. User Guide.

* Wed Jan 27 2016 Severin Gehwolf <sgehwolf@redhat.com> - 1.4.2-70.1
